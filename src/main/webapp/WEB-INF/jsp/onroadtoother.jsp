        ...
        <c:forEach var="item" items="${orders}" varStatus="status">
            <div class="layui-card-body" style="width:30%;float:left;background-color:#FFFAFA;margin-left:3%;margin-right:3%;margin-bottom:3%;">
                ...
                <div class="layui-card-body">
                    <form class="layui-form" name="form" action="/intoother/${item.id}" method="post">
                        货物类型 ： ${item.type}<br/>
                        目的地点 ： ${item.endPos}<br/>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-input-block"style="margin-left:0px;">
                                <button type="submit" class="layui-btn" style="height:25px;line-height: 25px;margin-top:5px;" >订单到达</button>
                            </div>
                        </div>
                    </form>
                </div>
