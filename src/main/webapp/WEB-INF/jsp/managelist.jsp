...
<table class="layui-table" lay-even="" lay-skin="row" style="margin:40px;width:90%">
    ...
    <tr>
        ...
        <th style="text-align:center;margin:auto">安排运力</th>
    </tr>
    </thead>
    <tbody>
    ...
    <c:forEach var="item" items="${orders}" varStatus="status">
        <tr>
            ...
            <td style="text-align:center;margin:auto"><button type="button" class="layui-btn" onclick="window.location.href = '/manageplan/${item.id}'"><i class="layui-icon"></i></button></td>
        </tr>
    </c:forEach>
